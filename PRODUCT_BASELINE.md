...
V1 使用用户选定的原创图标方案：深青绿圆角方形底板、白色聊天气泡、气泡下部/右下横向四段橙黄到橙红进度条。视觉含义是 conversation + local risk trend warning。
...
manifest 的 `action.default_title` 使用“ChatGPT 长会话预警”，仅描述适用网页，不表示官方关系。
